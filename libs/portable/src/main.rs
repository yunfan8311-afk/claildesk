...
const APP_PREFIX: &str = "claildesk";
const APPNAME_RUNTIME_ENV_KEY: &str = "claildesk_APPNAME";
#[cfg(windows)]
...
mod windows {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_claildesk.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &PathBuf) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_claildesk.exe"])
