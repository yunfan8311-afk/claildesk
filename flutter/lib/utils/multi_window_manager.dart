...
class claildeskMultiWindowManager {
  claildeskMultiWindowManager._();

  static final instance = claildeskMultiWindowManager._();
  ...
  /// `claildeskWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final claildeskWinManager = claildeskMultiWindowManager.instance;
