...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (claildeskWinManager.getActiveWindows().contains(kMainWindowId)) {
        await claildeskWinManager.unregisterActiveWindow(kMainWindowId);
      }
...
class AddButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ActionIcon(
        ...
        icon: IconFont.add,
        onTap: () => claildeskWinManager.call(
