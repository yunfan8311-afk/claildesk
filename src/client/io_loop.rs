        ...
        .await
        {
            Ok(((mut peer, direct, pk), (feedback, rendezvous_server))) => {
                ...
                let mut status_timer =
                    crate::claildesk_interval(time::interval(Duration::new(1, 0)));
                    ...
                    tokio::select! {
                        ...
                        _ = self.timer.tick() => {
                            ...
                            if !self.read_jobs.is_empty() {
                                ...
                                self.timer = crate::claildesk_interval(time::interval_at(Instant::now() + SEC30, SEC30));
                            }
                        }
                        _ = status_timer.tick() => {
                ...
                if is_remote {
                    ...
                    match fs::TransferJob::new_read(
                        ...
                        Ok(job) => {
                            ...
                            self.timer = crate::claildesk_interval(time::interval(MILLI1));
                            allow_err!(
            ...
            match msg_in.union {
                ...
                Some(message::Union::Misc(misc)) => match misc.union {
                    ...
                    Some(misc::Union::PermissionInfo(p)) => {
                        ...
                        // https://github.com/claildesk/claildesk/issues/3703#issuecomment-1474734754
