...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("claildesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://claildesk.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://claildesk.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/claildesk/claildesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("claildesk docs home", LINK_DOCS_HOME),
        ("claildesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("claildesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs-ny.claildesk.com"];
