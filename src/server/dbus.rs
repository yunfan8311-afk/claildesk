...
///
/// Note:
/// On linux, we use dbus to communicate multiple claildesk process.
...
const DBUS_NAME: &str = "org.claildesk.claildesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "claildesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.claildesk.claildesk /dbus org.claildesk.claildesk.NewConnection string:'PEER_ID'`
