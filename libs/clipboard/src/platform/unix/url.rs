...
// "/home/claildesk/pictures/ðŸ–¼ï¸?png" -> "file:///home/claildesk/pictures/%F0%9F%96%BC%EF%B8%8F.png"
...
mod uri_test {
    #[test]
    fn test_conversion() {
        let path = std::path::PathBuf::from("/home/claildesk/pictures/ðŸ–¼ï¸?png");
        let uri = super::encode_path_to_uri(&path).unwrap();
        assert_eq!(
            uri,
            "file:///home/claildesk/pictures/%F0%9F%96%BC%EF%B8%8F.png"
        );
    ...
    #[test]
    fn parse_list() {
        let uri_list = r#"file:///home/claildesk/pictures/%F0%9F%96%BC%EF%B8%8F.png
file:///home/claildesk/pictures/%F0%9F%96%BC%EF%B8%8F.png
"#;
